all:
	echo "ProjetoB"
	gcc -o partB.exe disk.c ppos_disk.c ppos-core-aux.c pingpong-disco1.c libppos_static.a -lrt
...
pB:
	echo "ProjetoB"
	gcc -o out.exe disk.c ppos_disk.c pingpong-disco1.c ppos-core-aux.c libppos_static.a -lrt